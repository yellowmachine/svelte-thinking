...
<div class="mx-auto max-w-5xl px-6 py-8">
	...
	{#if notebooks.length === 0}
		<div class="rounded-xl border border-dashed border-paper-border p-12 text-center dark:border-dark-paper-border">
			<p class="font-sans text-sm text-ink-faint dark:text-dark-ink-faint">
				No notebooks yet. Import a <code class="rounded bg-paper-ui px-1 font-mono text-xs dark:bg-dark-paper-ui">.ipynb</code> file or connect to a remote Jupyter server.
			</p>
		</div>
	{:else}
