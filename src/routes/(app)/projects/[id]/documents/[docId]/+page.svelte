		...
		{#snippet editableTitle()}
			<div class="mb-6">
				...
				{#if sourceRefCitation}
					<div
						class="mt-3 flex items-start gap-2 rounded border border-paper-border bg-paper-ui px-3 py-2 dark:border-dark-paper-border dark:bg-dark-paper-ui"
					>
						<svg
							width="12"
							height="12"
							...
							stroke-linecap="round"
							stroke-linejoin="round"
							class="mt-0.5 shrink-0 text-ink-faint dark:text-dark-ink-faint"
							aria-hidden="true"
						>
						...
						<p
							class="font-sans text-xs leading-relaxed text-ink-faint dark:text-dark-ink-faint"
							translate="no"
						>
