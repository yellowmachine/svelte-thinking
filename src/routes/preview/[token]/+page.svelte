...
<svelte:head>
	...
	<meta name="description" content="Shared document version on Scholio — collaborative academic writing." />
	<meta name="robots" content="noindex, nofollow" />
	<link rel="icon" href={favicon} />
</svelte:head>

<!-- Navbar -->
<header class="sticky top-0 z-20 border-b border-paper-border bg-paper/95 backdrop-blur-sm dark:border-dark-paper-border dark:bg-dark-paper/95">
	<div class="mx-auto flex max-w-5xl items-center justify-between gap-4 px-6 py-3">
		...
		<div class="flex items-center gap-3">
			...
			<span class="hidden h-4 w-px bg-paper-border dark:bg-dark-paper-border sm:block"></span>
			<span class="hidden items-center gap-1.5 sm:flex">
				<span class="max-w-[180px] truncate font-sans text-sm text-ink-muted dark:text-dark-ink-muted">
					{data.document.title}
				</span>
				<span class="rounded-md bg-accent/10 px-1.5 py-0.5 font-sans text-[10px] font-semibold text-accent">
...
<main class="mx-auto max-w-2xl px-6 py-12">
	...
	<div class="mb-8 border-b border-paper-border pb-6 dark:border-dark-paper-border">
		...
		{/if}
		<div class="mt-3 flex flex-wrap items-center gap-3 font-sans text-xs text-ink-faint dark:text-dark-ink-faint">
...
<!-- Footer CTA -->
<footer class="mt-16 border-t border-paper-border bg-paper-ui/50 py-12 dark:border-dark-paper-border dark:bg-dark-paper-ui/50">
