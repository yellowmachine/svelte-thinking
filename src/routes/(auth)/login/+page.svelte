...
<div class="rounded-2xl border border-paper-border bg-paper p-8 dark:border-dark-paper-border dark:bg-dark-paper">
	{#if showTotpStep}
		<!-- ── 2FA Step ── -->
		<h2 class="font-serif text-2xl font-semibold text-ink dark:text-dark-ink">Two-step verification</h2>
		...
		<form method="post" action="?/verifyTotp" use:enhance class="mt-6 flex flex-col gap-4">
			<div class="flex flex-col gap-1.5">
				<label for="code" class="font-sans text-sm font-medium text-ink dark:text-dark-ink">TOTP code</label>
				<input
					id="code"
					type="text"
					name="code"
	...
	{:else}
		...
		<form method="post" action="?/signInEmail" use:enhance class="mt-6 flex flex-col gap-4">
			...
			<div class="flex flex-col gap-1.5">
				<label for="password" class="font-sans text-sm font-medium text-ink dark:text-dark-ink">Password</label>
				<input
					id="password"
					type="password"
					name="password"
		...
		<div class="relative my-6 flex items-center">
			...
			<span class="mx-3 font-sans text-xs text-ink-faint dark:text-dark-ink-faint">or continue with</span>
			<div class="flex-1 border-t border-paper-border dark:border-dark-paper-border"></div>
		</div>
