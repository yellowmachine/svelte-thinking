...
export const reference = scholioSchema
	.table(
		'reference',
		{
			...
			readingNotesDocId: text('reading_notes_doc_id').references(() => document.id, {
				onDelete: 'set null'
			}),
...
export const referenceSubnote = scholioSchema
	.table(
		'reference_subnote',
		{
...
export const projectReference = scholioSchema
	.table(
		'project_reference',
		{
			referenceId: text('reference_id')
