...
export const document = scholioSchema.table(
	...
	(t) => [
		...
		// INSERT: owner or any collaborator
		...
		// UPDATE: 1 writer invariant.
		// writerUserId NULL  → only owner can write.
		// writerUserId SET   → only that user can write (owner loses access until reclaim).
