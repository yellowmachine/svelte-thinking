...
export const orgMemberRoleEnum = scholioSchema.enum('org_member_role', ['admin', 'member', 'guest']);
...
export const organization = scholioSchema.table(
	'organization',
	{
...
export const organizationMember = scholioSchema.table(
	'organization_member',
	{
		id: text('id').primaryKey(),
		orgId: text('org_id')
...
export const organizationApiKey = scholioSchema.table(
	'organization_api_key',
	{
		id: text('id').primaryKey(),
		orgId: text('org_id')
...
export const orgInvitation = scholioSchema.table(
	'org_invitation',
	{
		id: text('id').primaryKey(),
		orgId: text('org_id')
